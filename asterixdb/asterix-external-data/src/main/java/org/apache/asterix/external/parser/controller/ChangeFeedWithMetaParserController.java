...
public class ChangeFeedWithMetaParserController<T> extends FeedWithMetaParserController<T> {

    public ChangeFeedWithMetaParserController(final IRecordWithMetadataParser<T> dataParser)
